...
| `unit_price` | Float | Precio unitario asignado al ítem. Puede ser entero o con decimales. Ten en cuenta que las integraciones para Chile no soportan decimales. Ten en cuenta que las integraciones para Chile no soportan decimales. |
