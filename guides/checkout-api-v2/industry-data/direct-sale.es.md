...
Estos son los datos específicos para la industria **venta directa** que puedes agregar a tu integración para mejorar la aprobación de los pagos.
...
| `local_pickup` | Boolean | Si se retira en la sucursal, coloca `1`. De lo contrario, coloca `0`. |
