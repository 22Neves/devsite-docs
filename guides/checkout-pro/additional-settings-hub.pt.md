...
* [Configurar meios de pagamento](/developers/pt/docs/checkout-pro/additional-settings/preferences/payment-methods)
* [Ativar modo binário](/developers/pt/docs/checkout-pro/additional-settings/preferences/binary-mode)
* [Criar preferência para diversos itens](/developers/pt/docs/checkout-pro/additional-settings/preferences/preference-multiple-items)
* [Definir vigência da preferência](/developers/pt/docs/checkout-pro/additional-settings/preferences/term-of-preference)
* [Exibir valor de envio](/developers/pt/docs/checkout-pro/additional-settings/preferences/shipping-cost)