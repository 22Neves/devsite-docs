...
Once you have configured the payment preference, it is time to [Configure the URLs](/developers/en/docs/checkout-pro/configure-urls) to which your customers will be redirected at the end of the payment process.