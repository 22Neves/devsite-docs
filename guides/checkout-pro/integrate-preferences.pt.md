...
Para configurar uma preferência de pagamento, utilize o método correspondente ao preference no SDK de backend. É necessário criar uma nova preferência de pagamento para cada pedido ou fluxo de pagamento que você deseja iniciar.
