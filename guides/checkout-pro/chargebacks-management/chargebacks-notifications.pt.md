...
Essas notificações fornecem informações completas sobre o processo iniciado pelo cliente, sendo fundamentais para [gerenciar a contestação](/developers/pt/docs/checkout-pro/additional-content/chargebacks/manage).