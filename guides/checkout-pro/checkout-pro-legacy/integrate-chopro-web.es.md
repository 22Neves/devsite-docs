...
Luego, inicializa la integración configurando tu [clave pública](/developers/es/docs/checkout-pro/resources/credentials) usando el siguiente código JavaScript.
