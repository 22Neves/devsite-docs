...
> NOTE 
>  
> This documentation exclusively covers the configuration of payment notifications, including creations and updates, through the **Payments** event. To obtain information about other notification events available for configuration, please refer to the [general Notifications documentation](/developers/pt/docs/checkout-pro/additional-content/your-integrations/notifications).
