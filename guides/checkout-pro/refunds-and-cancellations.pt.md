...
- **Cancelamento**: Realizado quando um pagamento não foi finalizado ou está em processo. Nesse caso, o valor é devolvido ao cartão do comprador dentro do prazo estabelecido pelo banco emissor.
