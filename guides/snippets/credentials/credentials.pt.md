...
2. Acesse sua aplicação ou crie um se ainda não o fez.
...
> NOTE
>
> As credenciais de teste não precisam ser ativadas. Apenas criando uma aplicação, você já poderá utilizá-las.
