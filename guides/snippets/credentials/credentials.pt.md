...
:toolTipComponent[aplicativo]{link="/developers/es/docs/your-integrations/application-details" linkText="Detalhes do aplicativo" content="Entidade registrada no Mercado Pago que atua como um identificador para gerenciar suas integrações. Para mais informações, acesse a documentação."} que você criou através de Suas integrações.
