...
Con ellas, es posible acceder a las :toolTipComponent[credenciales]{link="/developers/es/docs/checkout-api/more-resources/credentials" linkText="Credenciales" content="Claves de acceso únicas con las que identificamos una integración en tu cuenta, vinculadas a tu aplicación. Para más información, accede al link a continuación."} necesarias para interactuar con nuestras APIs o servicios específicos, así como gestionar y organizar tu integración. 
