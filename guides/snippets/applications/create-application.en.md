...
With them, you can access the necessary :toolTipComponent[credentials]{link="/developers/en/docs/checkout-api/more-resources/credentials" linkText="Credentials" content="Unique access keys used to identify an integration in your account, linked to your application. For more information, access the link below."} to interact with our APIs or specific services, as well as manage and organize your integration.
