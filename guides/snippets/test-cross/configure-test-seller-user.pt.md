...
As [contas de teste](developers/pt/docs/your-integrations/introduction) são usuários que têm as mesmas funcionalidades que um usuário real do Mercado Pago, mas permitem testar o funcionamento do seu desenvolvimento sem comprometer dados reais.
