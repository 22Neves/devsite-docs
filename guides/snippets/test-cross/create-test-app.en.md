...
3. Still in the incognito window, within [Your Integrations](/developers/panel/app), click on **Create application** and follow the steps to create an :toolTipComponent[application]{content="Entity registered in Mercado Pago that acts as an identifier for managing your integrations. Refer to the Create Application step if you need to learn how to do it."} in order to have your test application linked to your seller user.
