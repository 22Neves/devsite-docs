...
Las [cuentas de prueba](/developers/es/docs/test/accounts) son usuarios que tienen las mismas funcionalidades que un usuario real de Mercado Pago, pero permiten probar el funcionamiento de tu desarrollo sin comprometer datos reales. 
