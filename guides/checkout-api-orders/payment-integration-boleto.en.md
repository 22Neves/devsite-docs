...
With Mercado Pago's ----[mlb]---- Checkout Transparente,------------ ----[mla, mlm]---- Checkout API,------------ it is also possible to offer payments with **boleto bancário**.
...
If you already [set up your environment](/developers/en/docs/checkout-api-v2/development-environment)  and want to offer payments with boleto bancário, follow the steps below.
...
If you already have a development that includes the retrieval of document types, as indicated below, proceed to [Submit payment](/developers/en/docs/checkout-api-v2/payment-integration/boleto#:~:text=server%2Dside-,Submit,-payment).
