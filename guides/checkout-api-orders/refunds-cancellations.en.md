...
There are two ways to :TagComponent{tag="API" text="process a refund" href="/developers/en/reference/orders/online-payments/refund/post"}:
...
To process full or partial refunds for a payment and to check the refunds made in your store, visit our API Reference and access the endpoint :TagComponent{tag="API" text="Refund an order" href="/developers/en/reference/orders/online-payments/refund/post"}.
