...
| --- | --- |--- |
| Procesamiento del pago	  | Automático (crea y procesa tu transacción). | [Automático y manual](/developers/es/docs/checkout-api-v2/integration-model#bookmark_modos_de_procesamiento_de_orders) (eligiendo cuándo procesar la transacción). |
