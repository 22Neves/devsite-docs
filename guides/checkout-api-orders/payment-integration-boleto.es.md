...
Si ya [configuraste tu ambiente](/developers/es/docs/checkout-api/development-environment), y quieres ofrecer pagos con boleto bancário, sigue los pasos a continuación.
