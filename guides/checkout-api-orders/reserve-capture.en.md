...
It is also possible to receive a pending status. In these cases, you should pay attention to the [notifications sent by Mercado Pago](/developers/en/docs/checkout-api/v2/notifications) to know what the final status of the payment is.
