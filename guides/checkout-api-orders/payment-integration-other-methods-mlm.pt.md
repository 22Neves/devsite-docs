...
Se você deseja continuar com a sua integração após ter [configurado seu ambiente](/developers/pt/docs/checkout-api/development-environment) e quer oferecer pagamentos com OXXO, Paycash, Citibaname e BBVA Bancomer, siga os passos abaixo.
