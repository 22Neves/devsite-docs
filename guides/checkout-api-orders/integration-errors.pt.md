...
Para obter mais informações sobre como enviar as solicitações, requisitos e validações necessárias, consulte nossa :TagComponent{tag="API" text="Referência de API" href="/developers/en/reference/order/online-payments/create/post"}.
