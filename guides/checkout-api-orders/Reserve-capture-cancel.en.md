...
By integrating card payments with Checkout API, it is possible to process the transactions by reserving funds and subsequently capturing them. See below how to manage these transactions.
