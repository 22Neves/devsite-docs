...
Para cancelar una reserva, debes enviar una solicitud al endpoint :TagComponent{tag="API" text="/v1/orders/{order_id}/cancel" href="/developers/es/reference/order/online-payments/cancel-order/post"}. Asegúrate de reemplazar `{order_id}` por el ID de la order cuya reserva deseas cancelar.