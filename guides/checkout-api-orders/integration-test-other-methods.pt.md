...
Pronto! Após concluir estas etapas, a integração de outros meios de pagamento estará completa e você poderá continuar testando suas outras configurações ou [subir em produção](/developers/pt/docs/checkout-api-v2/go-to-production).
