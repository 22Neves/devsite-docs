...
Si deseas continuar con tu integración luego de haber [configurado tu ambiente](/developers/es/docs/checkout-api/development-environment), y quieres ofrecer pagos con Rapipago y/o Pago Fácil, sigue los pasos a continuación.
...
Si deseas continuar con tu integración luego de haber [configurado tu ambiente](/developers/es/docs/checkout-api/development-environment), y quieres ofrecer pagos conOXXO, Paycash, Citibaname y BBVA Bancomer, sigue los pasos a continuación.
