...
To test your integration with these payment methods, after configuring your [test environment](/developers/en/docs/checkout-api-v2/integration-test), access the store that has integrated your checkout, select a product or service, and start the purchase process.
...
Ready! Once these steps are completed, the integration of other payment methods is complete and you can either continue testing your other configurations or [go to production](/developers/en/docs/checkout-api-v2/go-to-production).