...
| `payer.adress.street_name`      | _Body. String_   |Número de la dirección del pagador. Si no tiene un número, envía "S/N".                                                                                                               | Requerido          |
...
| `payer.adress.state`                                 | _Body. String_  | Estado en el que se encuentra la dirección del pagador. Para Brasil, este parámetro solo **acepta dos caracteres**. Ejemplo: SP.                                                                    | Requerido          |
