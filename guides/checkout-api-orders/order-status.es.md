...
| `processing` | `in_process` | La order está en procesamiento. Esto significa que la transacción está en curso y aún no se ha completado. Este status también puede ser devuelto en caso de creación de pagos de forma asíncrona. |
