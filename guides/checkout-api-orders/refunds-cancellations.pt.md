...
- **Cancelamento**: é feito quando um pagamento ainda não foi aprovado e o limite é devolvido ao cartão do comprador dentro do período definido pelo banco emissor.
