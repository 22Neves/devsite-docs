...
----[mlc, mlm, mco, mlu]----
![status-screen-external-reference](checkout-bricks/status-screen-reference-all-es.png)

------------
----[mpe]----
![status-screen-external-reference](checkout-bricks/status-screen-external-mpe-es.png)
