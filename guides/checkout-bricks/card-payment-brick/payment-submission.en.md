...
> Note
>
> To consult the types and specifications that can be sent and received by the Brick in the onSubmit callback, check the [technical documentation](https://github.com/mercadopago/sdk-js/blob/main/docs/bricks/card-payment.md).
