...
> h1
>
> Cuenta de Mercado Pago y Conta Mercado Pago e ----[mlb]---- Linha de Crédito ------------ ----[mla]---- Cuotas sin Tarjeta ------------ ----[mla]---- Meses sin Tarjeta ------------

Los pagos con **Cuenta de Mercado Pago y Conta Mercado Pago e ----[mlb]---- Linha de Crédito ------------ ----[mla]---- Cuotas sin Tarjeta ------------ ----[mla]---- Meses sin Tarjeta ------------**, la opción de pagar en cuotas sin contar con una tarjeta, no necesitan ser enviados a través del backend. 
