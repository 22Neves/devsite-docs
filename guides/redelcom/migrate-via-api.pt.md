...
Para configurar a integração das impressões, utilize a API para gerenciar o enfileiramento de cada uma das tentativas, considerando as especificações de cada endpoint. Os endpoints disponíveis são:
