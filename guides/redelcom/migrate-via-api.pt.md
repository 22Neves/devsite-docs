...
- [Obter terminals](/developers/pt/reference/order/in-person-payments/point/terminal/get): Este endpoint permite obter uma lista dos terminals Point disponíveis associados à sua conta do Mercado Pago. Ele indicará seu respectivo ID e o modo de operação em que está funcionando.
