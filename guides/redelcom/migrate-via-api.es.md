...
| Credenciales                           | Las credenciales son claves únicas que te son proporcionadas en el momento en que creas la aplicación a través de [Tus integraciones](/developers/panel/app). Necesitarás un par de credenciales de producción para recibir pagos reales. Accede a [Credenciales](/developers/es/docs/your-integrations/credentials) para más información. |
