...
Após localizar os dados do cartão associado ao cliente, utilize um dos _snippets_ abaixo para tokenizar o cartão utilizando seu ID (`card_id`). A tokenização fornece uma experiência de pagamento digital mais segura substituindo o número do cartão por um número alternativo, o token.
