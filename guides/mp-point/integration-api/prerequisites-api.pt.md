...
> RED_MESSAGE
>
> Mercado Pago está evoluindo a maneira de integrar e agora oferecemos uma nova API para realizar integrações com o Mercado Pago Point, que descontinuará a API atual. Caso você esteja integrando esta solução de pagamento pela primeira vez, utilize os [endpoints da nova API de Orders](/developers/pt/reference/orders/in-person-payments/point/terminal/get). <br>
> Se você já integrou Point anteriormente, em breve traremos mais informações sobre o processo de migração.

| Requisito | Descrição |
|---|---|
| ----[mlm, mlb]---- Dispositivo **Point Smart** Mercado Pago ------------ ----[mla]---- Dispositivo **Point Smart ou Point Plus** Mercado Pago ------------ -| Para oferecer pagamentos presenciais através do Point, é necessário adquirir a máquina. Se ainda não o fez, vá para a [loja](https://www.mercadopago[FAKER][URL][DOMAIN]/point). |
