...
Below is an example request. Please remember to replace the value of the `token` field with your Access Token. [Go to the OAuth documentation](/developers/en/docs/oauth/introduction) for more information about the Access Token.
