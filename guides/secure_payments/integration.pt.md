...
A seguir, compartilhamos um exemplo de solicitação. Lembre-se de alterar o valor do campo `token` pelo seu Access Token. [Acesse a documentação do OAuth](/developers/pt/docs/oauth/introduction) para mais informações sobre o Access Token.
