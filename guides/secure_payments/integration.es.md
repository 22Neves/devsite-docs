...
A continuación, te compartimos un pedido de ejemplo. Ten en cuenta que deberás cambiar el valor del campo `token` por tu Access Token. [Accede a la documentación de OAuth](/developers/es/docs/oauth/introduction) para más información sobre el Access Token.
