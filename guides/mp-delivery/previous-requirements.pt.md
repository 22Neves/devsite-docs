...
|---|---|
| Permissão de utilização | Para habilitar sua aplicação para essa integração e consumir as APIs citadas na documentação, entre em contato com seu **executivo comercial**.   |
