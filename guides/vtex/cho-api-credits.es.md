...
Para configurar Cuotas sin Tarjeta en el checkout de la tienda, dirígete al panel de administración de tu plataforma VTEX, y accede a **Pagos> Configuración > Planes de pago**. Luego, sigue las instrucciones a continuación:
...
Para configurar Meses sin Tarjeta en el checkout de la tienda, dirígete al panel de administración de tu plataforma VTEX, y accede a **Pagos> Configuración > Planes de pago**. Luego, sigue las instrucciones a continuación:
