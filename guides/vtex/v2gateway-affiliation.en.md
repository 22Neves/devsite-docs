...
| Moeda - Moneda | ----[mlu]---- Configure the store's currency (**USD** or **Local**) for integrations with the payment method [Checkout Pro](/developers/en/docs/vtex/payments-configuration/checkout-pro). ------------ ----[mla, mlm, mlb, mco, mpe, mlc]---- This field identifies the store's currency. You don’t need to fill it. ------------ |
