...
| Mercado Pago inStore | Integre seus canais de vendas online às suas lojas físicas para melhorar a experiência dos seus clientes. Veja mais informações no [Guia de instalação VTEX Sales App e Mercado Pago inStore](). |
| VTEX Subscriptions | Configure planos de assinatura para gerar pedidos de compra de forma automática e cobre com base na frequência e nos valores definidos. Seus clientes fazem a assinatura dos seus produtos e/ou serviços para pagar no débito automático por quanto tempo quiserem. Veja mais informações no [Guia de instalação VTEX Subscriptions](). |
