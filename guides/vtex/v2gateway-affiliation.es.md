...
| Moeda - Moneda | ----[mlu]---- Configura la moneda de la tienda (**USD** o **Local**) para las integraciones con el método de pago [Checkout Pro](/developers/es/docs/vtex/payments-configuration/checkout-pro). ------------ ----[mla, mlm, mlb, mco, mpe, mlc]---- Este campo identifica la moneda de la tienda. No es necesario que lo completes. ------------  |
