...
1. Accede al panel de administración de tu plataforma **VTEX > Pagos > Proveedores**.
...
| Prazo de captura de pagamento aprobado - Plazo de captura de pagos aprobado | En este campo, configure como **inmediato** el plazo para la captura de los pagos aprobados. |
