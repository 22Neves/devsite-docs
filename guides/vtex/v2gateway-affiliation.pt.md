...
| Moeda | ----[mlu]---- Configure a moeda da loja (**USD** ou **Local**) para as integrações com o meio de pagamento [Checkout Pro](/developers/pt/docs/vtex/payments-configuration/checkout-pro). ------------ ----[mla, mlm, mlb, mco, mpe, mlc]---- Este campo identifica a moeda da loja. Não é necessário completá-lo. ------------  |
