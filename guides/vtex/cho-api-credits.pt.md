...
Para configurar a Linha de Crédito no checkout da loja, acesse o painel de administração da plataforma VTEX e vá para **Pagamentos > Configuração > Planos de pagamento**. Então, siga as instruções abaixo: 
...
Para configurar o Cuotas sin Tarjeta no checkout da loja, acesse o painel de administração da plataforma VTEX, e vá para **Pagamentos > Configuração > Planos de pagamento**. Então, siga as instruções abaixo: 
...
Para configurar o Meses sin Tarjeta no checkout da loja, acesse o painel de administração da plataforma VTEX, e vá para **Pagamentos > Configuração > Planos de pagamento**. Logo, siga as instruções abaixo: 
