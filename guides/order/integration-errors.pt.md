...
Para obter mais informações sobre como enviar as solicitações, requisitos e validações necessárias, consulte nossa Referência de API para [Pagamentos online](/developers/pt/reference/order/online-payments/create/post) e [Pagamentos presenciais](/developers/pt/reference/order/in-person-payments/point/terminal/get).
