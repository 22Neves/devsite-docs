...
Para obtener más información sobre cómo enviar las solicitudes, requerimientos y validaciones necesarias, consulta nuestra Referencia de API para [Pagos online](/developers/es/reference/order/online-payments/create/post) y [Pagos presenciales](/developers/es/reference/order/in-person-payments/point/terminal/get).