...
| Credentials | Credentials are unique keys that we provide for you to configure your integrations. You will need a pair of production credentials to test the integration and to receive actual payments. See [Credentials](/developers/en/docs/order/additional-content/your-integrations/credentials) for more information. |
