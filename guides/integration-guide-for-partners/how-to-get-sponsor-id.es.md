...
Para obtener el ID de la cuenta de Mercado Pago, siga los pasos a continuación.
...
![Tus integraciones](/images/integration-guide-for-partners/partners-guide-1-es.png)

2. Después de crear la aplicación, haz clic para acceder a ella.

![Aplicación creada](/images/integration-guide-for-partners/partners-guide-2-es.png)
...
![ID de la cuenta de Mercado Pago](/images/integration-guide-for-partners/partners-guide-3-es.png)
