...
Existen también **campos extra** que pueden ser enviados dependiendo del **ramo de actividades o industria** de tu tienda. Puedes encontrar más detalles sobre cada ramo y los datos del comprador y del envío que recomendamos incluir en cada uno de ellos en la documentación [Datos adicionales sobre industrias](/developers/es/docs/checkout-api/additional-content/industry-data/intro).
