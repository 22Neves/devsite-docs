...
> Importante
>
> Si estás integrando como una plataforma o PDV (Punto de Venta), recuerda configurar OAuth para que puedas identificar correctamente los pagos de tus vendedores. Consulta [OAuth](/developers/es/docs/security/oauth) para obtener más información.
