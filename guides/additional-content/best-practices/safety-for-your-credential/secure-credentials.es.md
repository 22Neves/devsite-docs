...
1. Ve al [Panel del desarrollador](https://www.mercadopago[FAKER][URL][DOMAIN]/developers/panel/app). 
...
Para conocer más sobre OAuth, ve a [esta documentación](/developers/es/docs/oauth/introduction).