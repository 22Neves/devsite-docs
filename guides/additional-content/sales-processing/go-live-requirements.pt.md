...
Para oferecer a melhor experiência tanto para o vendedor quanto para o comprador, é necessário avaliar a [qualidade de sua integração](/developers/pt/docs/integration-quality) com a nossa ferramenta de medição. 
