...
> <br><br>
> Ao usar o OAuth, é importante considerar alguns aspectos para que a integração funcione corretamente. Acesse as [Boas práticas para a integração do OAuth](/developers/pt/docs/oauth/best-practices) e veja um guia para possíveis erros e boas práticas para utilização do OAuth.
