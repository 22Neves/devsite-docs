...
> <br><br>
> When using OAuth, it is important to take certain aspects into account so that the integration works correctly. Access the [Best practices for OAuth integration](/developers/en/docs/oauth/best-practices) and check a guide to possible errors and good practices to keep in mind.
