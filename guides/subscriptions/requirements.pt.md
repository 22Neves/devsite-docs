...
| Integração com SDK Javascript - CardToken ID | A integração com o SDK Javascript do Mercado Pago permite criar um token com os dados do cartão e enviá-lo ao seu backend para ser usado nos pagamentos. Para mais informações, [clique aqui](/developers/pt/docs/subscriptions/additional-content/cardtoken).|
