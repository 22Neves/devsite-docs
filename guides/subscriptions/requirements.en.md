...
| Integration with Javascript SDK - CardToken ID | Integration with Mercado Pago's Javascript SDK allows you to create a token with card data and send it to your backend to be used for payments. For more information, [click here](/developers/en/docs/docs/subscriptions/additional-content/cardtoken) |
